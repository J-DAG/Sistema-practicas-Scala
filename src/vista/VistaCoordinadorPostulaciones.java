...
public class VistaCoordinadorPostulaciones extends JFrame {
    ...
    public JButton btnRevisar;
    public JTextField txtBuscar;
    public JTable tblPostulaciones;

    public VistaCoordinadorPostulaciones() {
        setTitle("Administracion de postulaciones");
        setSize(1200, 800);
        setResizable(false);
        ...
        lblSubTitulo = new JLabel("Administracion de postulaciones");
        lblSubTitulo.setFont(new Font("Dialog", Font.BOLD, 18));
        lblSubTitulo.setBounds(40, 80, 401, 31);
