...
public class VistaTAPracticasCompletadas extends JFrame {
    ...
    public JTable tblEstudiantesTA;

    public VistaTAPracticasCompletadas() {
        setTitle("Practicas completadas");
        setSize(1200, 800);
        setResizable(false);
        ...
        lblSubTitulo = new JLabel("Calificacion de estudiantes a cargo");
        lblSubTitulo.setFont(new Font("Dialog", Font.BOLD, 18));
        lblSubTitulo.setBounds(50, 90, 431, 31);
        getContentPane().add(lblSubTitulo);

        lblInformacion = new JLabel("Calificaciones de los estudiantes");
        ...
        btnActividades = new JButton("Calificar estudiante", new ImageIcon("./iconos/lists.png"));
        btnActividades.setFont(new Font("Dialog", Font.PLAIN, 10));
        btnActividades.setBounds(990, 170, 151, 31);
        getContentPane().add(btnActividades);

        tblEstudiantesTA = new JTable(new DefaultTableModel());
        JScrollPane scrollEstudiantes = new JScrollPane(tblEstudiantesTA);
