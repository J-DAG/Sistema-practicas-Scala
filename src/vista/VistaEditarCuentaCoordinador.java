...
public class VistaEditarCuentaCoordinador extends JFrame {
    ...
    public VistaEditarCuentaCoordinador() {
        setTitle("Editar informacion del coordinador");
        setSize(800, 620);
        setResizable(false);
        ...
        lblTitulo = new JLabel("Editar Informacion del Coordinador");
