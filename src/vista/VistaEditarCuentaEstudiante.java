...
public class VistaEditarCuentaEstudiante extends JFrame {
    ...
    public VistaEditarCuentaEstudiante() {
        ...
        lblCicloActual.setBounds(190, 420, 91, 21);
        getContentPane().add(lblCicloActual);

        cbsCicloActual = new JComboBox<>();
        cbsCicloActual.setFont(new Font("Segoe UI", Font.PLAIN, 10));
        cbsCicloActual.setBounds(190, 450, 431, 31);
        ...
        lblContrasenia.setBounds(190, 490, 91, 21);
        getContentPane().add(lblContrasenia);

        txtContrasenia = new JPasswordField();
        txtContrasenia.setFont(new Font("Segoe UI", Font.PLAIN, 10));
        txtContrasenia.setBounds(190, 520, 431, 31);
        ...
        lblConfirmarContrasenia.setBounds(190, 560, 151, 21);
        ...
        btnGuardar.setBounds(450, 650, 171, 31);
